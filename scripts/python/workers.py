...
class AgentWorker(QtCore.QThread):
    ...
    def __init__(self, core, user_message, system_context, agent_mode=False, parent=None):
    ...
    def run(self):
        ...
        for chunk in self.core.generate_response_stream(self.user_message, self.system_context, self.agent_mode, self.check_cancelled):
